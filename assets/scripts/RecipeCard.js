...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		//saves shadow DOM so we can reference it later
		this.shadow = this.attachShadow({mode: 'open'});
		// A2. TODO - Create an <article> element - This will hold our markup once our data is set
		this.article = document.createElement('article');
		// A3. TODO - Create a style element - This will hold all of the styles for the Web Component
		//we do not use this.style as it overwrites inline styles. This instead creates new style element
	...
	set data(data) {
		...
		//dont need to worry if param passed in are string or number - all are converted to string when
		//insert in a template literal
		article.innerHTML = `
...
//must be defined RecipeCard class above 
